      ...
      <div className="about-page-content">
        ...
        <div className="about-page-main">
          <div className="prose">
            ...
            <h2>How Our Publications Are Built</h2>
            <p>Every piece follows the same internal standard:</p>
            <ul>
              <li>Grounded in real design scenarios</li>
              <li>Written to be applied, not admired</li>
              <li>Structured for clarity over cleverness</li>
              <li>Edited for usefulness, not volume</li>
            </ul>
            <p>
              No filler. No listicles pretending to be insight. No inspirational posters disguised as articles.
            </p>

            <h2>Visual Style &amp; Imagery Guidance</h2>
            <p>If you're wiring this into the CMS or briefing visuals, use this as your baseline:</p>
            <ul>
              <li><strong>Mood:</strong> calm, focused, slightly tense</li>
              <li><strong>Scenes:</strong> desks, notes, whiteboards, reviews, quiet moments before meetings</li>
              <li><strong>Avoid:</strong> smiling teams, pointing at screens, generic startup nonsense</li>
              <li><strong>Color:</strong> neutral, muted, editorial</li>
              <li><strong>Composition:</strong> negative space, readable surfaces, human scale</li>
            </ul>
            <p>Images should feel like the moment before a decision, not after a launch party.</p>

            <h2>Publication Cadence</h2>
            <ul>
              <li>Curated releases, not content dumps</li>
              <li>Evergreen over algorithm-bait</li>
              <li>Each article is meant to stay relevant longer than a sprint</li>
            </ul>
            <p>If it doesn't hold up six months later, it doesn't ship.</p>

            <h2>Next logical steps</h2>
            <ul>
              <li>A featured publication layout</li>
              <li>Article page template content</li>
              <li>Editorial voice guidelines so contributors don't ruin this with enthusiasm</li>
            </ul>
          </div>
        </div>
        ...
        <aside className="about-page-sidebar">
          <div className="founder-card">
            ...
            />
            <p className="founder-title">Founder &amp; Editor</p>
            <h3 className="founder-name">Frank Robinson III Sr.</h3>
            <p className="founder-title" style={{ textTransform: 'none', fontSize: '0.95rem', fontWeight: 500 }}>
              UX Product Designer
            </p>
